(function($) {
    ...
    if ($('.testimonial-carousel-two').length) {
        $('.testimonial-carousel-two').owlCarousel({
            ...
            smartSpeed: 700,
            autoplay: true,
            navText: ['<span class="fa fa-long-arrow-left"></span> ant', 'pox<span class="fa fa-long-arrow-right"></span>'],
            responsive: {
                0: {
                    items: 1
                },
    ...
    if ($('.specialize-section-two .image-carousel').length && $('.specialize-section-two .thumbs-carousel').length) {
        ...
        $sync1
            .owlCarousel({
                ...
                margin: 0,
                nav: false,
                navText: ['<span class="icon fa fa-angle-left"></span>ant', 'prox<span class="icon fa fa-angle-right"></span>'],
                dots: false,
                autoplay: true,
