                            ...
                            <nav class="main-menu navbar-expand-md ">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="#">La Empresa</a>
                                            <ul>
                ...
                <div class="mixitup-gallery">
                    ...
                    <div class="filters text-center clearfix">
                        <ul class="filter-tabs filter-btns clearfix">
                            ...
                            <li class="filter" data-role="button" data-filter=".porcelanato">PORCELANATO</li>
                            <li class="filter" data-role="button" data-filter=".granito">GRANITO</li>
                            <li class="filter" data-role="button" data-filter=".travertinos">TRAVERTINOS</li>
                            <li class="filter" data-role="button" data-filter=".ceramicas">CERAMICAS</li>
                            <li class="filter" data-role="button" data-filter=".prueba">PRUEBA</li>
                        </ul>
                    </div>
                    ...
                    <div class="filter-list row">
                        ...
                        <div class="team-block all mix porcelanato granito ceramicas col-lg-3 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    <div class="image">
                                        <div data-aos="flip-up" data-aos-duration="8000">
                                            <a href="product-feature.html"><img src="<?php echo $producto['Imagen'];?>"
                                                    alt=""></a>
                                        </div>
                                    </div>
                                    <h3 class="name"><a
                                            href="product-feature.html"><?php echo $producto['Nombre'];?></a></h3>
                                </div>
                            </div>
                        </div>
